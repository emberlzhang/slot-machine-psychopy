...
keyboardArrows = ['left', 'down', 'right']
reward_seq = []
rand_val = 0
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Rupak\\Icahn\\CCP\\Psychopy\\tasks\\Psychopy_slotMachine_updated\\slotMachine_updated_lastrun.py',
...
thisExp.addData('key_resp_practice_instruction.started', practice_instructionClock.getTime())
...
thisExp.addData('key_resp.started', instruction2Clock.getTime())
...
for thisPractice_trial in practice_trials:
    ...
    while continueRoutine:
        ...
        if text_practice_slots_2.status == STARTED:  # only update if drawing
        ...
        if key_resp_practice_slots.status == STARTED and not waitOnFlip:
            theseKeys = key_resp_practice_slots.getKeys(keyList=['1','2','3','left','down','right'], waitRelease=False)
...
thisExp.addData('key_resp_practice_end.started',key_resp_practice_end.started)
# keep track of which components have finished
...
#thisExp.nextEntry()
conditions = [(12,20), (8,20), (7,20), (10,20), (7,14,20), (13,20)]
thisExp.addData('key_resp_main_instruction.started',key_resp_main_instruction.started)
...
for thisBlock in block:
    ...
    for thisMain_trial in main_trials:
        ...
        while continueRoutine:
            ...
            if text_slots_presentation_2.status == STARTED:  # only update if drawing
            ...
            if key_resp_slots_presentation.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_slots_presentation.getKeys(keyList=['1','2','3','left','down','right'], waitRelease=False)
